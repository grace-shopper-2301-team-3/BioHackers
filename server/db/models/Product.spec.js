...
describe('Product model', () => {
    ...
    describe('validations', () => {
        ...
        it('should require `productPrice`', async () => {
            ...
            try {
                await product.validate();
                throw Error('validation was successful but should have failed without `productPrice`');
            } catch (err) {
        ...
        it('should require `categoryId`', async () => {
            ...
            try {
                await product.validate();
                throw Error('validation was successful but should have failed without `categoryId`');
            } catch (err) {
        ...
        it('should have a description field of type Sequelize.TEXT', () => {
            expect(Product.rawAttributes.description.type).to.be.an.instanceof(Sequelize.TEXT);
        });

        it('should have a quantity field of type Sequelize.INTEGER', () => {
            expect(Product.rawAttributes.quantity.type).to.be.an.instanceof(Sequelize.INTEGER);
        });
